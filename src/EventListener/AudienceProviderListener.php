...
class AudienceProviderListener
{
    ...
    public function __invoke(CheckPassportEvent $event): void
    {
        ...
        if (!$passport->hasBadge(AudienceBadge::class)) {
            return;
        }

        /** @var AudienceBadge $badge */
        $badge = $passport->getBadge(AudienceBadge::class);
        if (null !== $badge->getAudienceLoader()) {
            return;
        }
